...
<html>
  ...
  <body>
    <%      //接收用户名和密码  
            ...
            PreparedStatement pStmt = conn.prepareStatement("select * from yonghu where name = '" + user + "' and password = '" + pwd + "'");
              ResultSet rs = pStmt.executeQuery();
                if(rs.next()){
                	session.setAttribute("username",name);
                    response.sendRedirect("liuyan.jsp?username="+URLEncoder.encode(user)); //解决乱码 
                }else{
